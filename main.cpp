...
int main()
{
	...
	lucesDados[1] = SpotLight(
		1.0f, 0.8f, 0.3f,                // Color calido
		1.5f, 2.0f,
		-120.0f, 30.0f, -220.0f,          // Posición 
		0.0f, -1.0f, 0.0f,             // Dirección 
		0.3f, 0.02f, 0.005f,             // Atenuación
		52.0f                           // Ángulo 
	);
	...
	lucesDados[2] = SpotLight(
		1.0f, 0.5f, 0.5f,                // Color calido
		1.5f, 2.0f,
		-80.0f, 30.0f, -220.0f,          // Posición 
		0.0f, -1.0f, 0.0f,             // Dirección 
		0.3f, 0.02f, 0.005f,             // Atenuación
		52.0f                           // Ángulo 
	);
	...
	lucesTopos[1] = SpotLight(1.0f, 0.8f, 0.5f,       // Color cálido
		2.0f, 2.5f,
		186.0f, 40.0f, -35.0f,                        // Posición en lo alto de la cabina
		0.0f, -1.0f, 0.0f,                           // Dirección hacia abajo
		0.3f, 0.02f, 0.009f,
		70.0f);                                       // Ángulo del cono
	lucesToposCount++;

	lucesTopos[2] = SpotLight(1.0f, 0.7f, 0.5f,       // Color cálido
		2.0f, 2.5f,
		150.0f, 40.0f, -50.0f,                        // Posición en lo alto de la cabina
		0.0f, -1.0f, 0.0f,                           // Dirección hacia abajo
		0.3f, 0.02f, 0.009f,
		70.0f);                                       // Ángulo del cono
	lucesToposCount++; 
